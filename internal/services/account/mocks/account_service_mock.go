...
func (_m *MockService) Create(ctx context.Context, trx models.Account) error {
...
func (_m *MockService) Get(ctx context.Context, query *models.Account) (*models.Account, error) {
...
func (_m *MockService) Update(ctx context.Context, Account *models.Account, update *models.Account) error {
