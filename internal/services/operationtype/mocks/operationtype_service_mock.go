...
func (_m *MockService) Create(ctx context.Context, trx models.OperationsType) error {
...
func (_m *MockService) Get(ctx context.Context, query *models.OperationsType) (*models.OperationsType, error) {
...
func (_m *MockService) Update(ctx context.Context, OperationType *models.OperationsType, update *models.OperationsType) error {
